...
public class StoredBookDAO  extends BaseDAO{
	...
	public StoredBookDAO(Context context){
	...
	public String createTableString() {
		...
		StringBuffer sql_stored_books = new StringBuffer();
		sql_stored_books.append("create table " + TABLE_STORED_BOOK + "(_id integer primary key autoincrement,")
		.append("book_id text,")
		...
		return sql_stored_books.toString();
	}
	...
	public String dropTable() {
		...
		buffer.append(TABLE_STORED_BOOK);
	...
	public void insert(Object obj) {
		// TODO Auto-generated method stub
		BookStoredEntity entity = (BookStoredEntity)obj;
		...
		resolver.insert(URI_STORED_BOOK, values);
	...
	public void delete(String where, String[] selectionArgs) {
		// TODO Auto-generated method stub
		ContentResolver resolver = context.getContentResolver();
		resolver.delete(URI_STORED_BOOK, where, selectionArgs);
		
	}

	@Override
	public ArrayList<BookStoredEntity> query(String[] selections, String where,
			String[] selectionArgs, String sortOrder) {
		// TODO Auto-generated method stub
		ContentResolver resolver = context.getContentResolver();
		Cursor cursor =  resolver.query(URI_STORED_BOOK, selections, where, selectionArgs, null);
		ArrayList<BookStoredEntity> arrayList = new ArrayList<BookStoredEntity>();
		
		BookStoredEntity entity = null;
	...
	public void update(Object obj, String where, String[] selectionArgs) {
		...
		resolver.update(URI_STORED_BOOK, values, where, selectionArgs);
